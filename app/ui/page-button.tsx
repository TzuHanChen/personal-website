  ...
  return (
    <Link href={href} target={outside ? "_blank" : "_self"}
      ...
      <div className="bg-gray-100 p-2 rounded-full group-active:bg-teal-700 transition-colors duration-300">
        {align == "right"
          ? <ArrowRightIcon className="size-6 stroke-gray-700 group-active:stroke-teal-100 transition-colors duration-300" />
          : <ArrowLeftIcon className="size-6 stroke-gray-700 group-active:stroke-teal-100 transition-colors duration-300" />}
      </div>
    </Link>
  )
}
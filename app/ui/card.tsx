...
export default function Card({ linkHref, imageSrc, name, description }: {
  ...
  return (
    <Link href={linkHref}
      ...
      <div className="rounded-b-3xl flex-1 bg-white p-6 flex flex-col">
        <h3 className="mb-3 flex items-center gap-3 text-2xl text-gray-900 group-active:text-teal-700 transition-colors duration-300">
          ...
          <span className="bg-gray-100 p-2 rounded-full group-active:bg-teal-700 transition-colors duration-300">
            <ArrowForwardIcon className="size-6 fill-gray-900 group-active:fill-teal-100 transition-colors duration-300" />
          </span>
        </h3>
  ...
  return (
    <div className="rounded-3xl min-h-80 bg-white p-6 flex flex-col justify-center items-center gap-6">
      <div className="bg-gray-100 p-3 rounded-full">
        <ProgressActivityIcon className="size-9 fill-gray-800 animate-spin" />
      </div>
